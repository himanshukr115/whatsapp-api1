...
async function seed() {
  ...
  try {
    ...
    await client.query(`
      ...
      VALUES
        ('Free', 'free', 0, 0, 100, 3, 1, FALSE, FALSE,
         '["100 DMs/month","3 active flows","Basic analytics","1 Instagram account","Email support"]', 1),
    ...
    await client.query(`
      ...
      VALUES ('himanshukr116@gmail.com', $1, 'admin', 'Admin User', 'FlowGram', TRUE)
      ON CONFLICT (email) DO UPDATE SET role = 'admin';
    `, [hash]);

    console.log('✅ Seeding completed');
    console.log('   Plans: Free / Pro / Business created');
    console.log('   Admin: himanshukr116@gmail.com / Admin@12345');
  } catch (err) {
